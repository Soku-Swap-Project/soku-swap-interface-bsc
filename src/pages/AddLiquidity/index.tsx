      ...
      <AutoColumn gap="20px">
        <LightCard mt="20px" borderRadius="20px">
          <RowFlat>
            ...
            >
              <UIKitText color="#04bbfb" fontSize="30px" mr="8px">
              ...
              <AutoColumn gap="20px">
                {noLiquidity && (
                  <ColumnCenter>
                    <Pane>
                      <AutoColumn gap="12px">
                        <UIKitText color="#04bbfb">
                          You are the first liquidity provider. The ratio of tokens you add will set the price of this
                          pool. Once you are happy with the rate click supply to review.
                        </UIKitText>
                      </AutoColumn>
                    </Pane>
                  </ColumnCenter>
